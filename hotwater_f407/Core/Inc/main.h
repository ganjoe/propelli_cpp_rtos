...
#define flow_cold_Pin GPIO_PIN_0
#define flow_cold_GPIO_Port GPIOE
#define flow_cold_EXTI_IRQn EXTI0_IRQn
#define flow_hot_Pin GPIO_PIN_1
#define flow_hot_GPIO_Port GPIOE
#define flow_hot_EXTI_IRQn EXTI1_IRQn
